...
class AnimateFromCoeff():
    ...
    def generate(self, x, video_save_dir, pic_path, crop_info, enhancer=None, background_enhancer=None, preprocess='crop', img_size=256, fps=25, restore_eyes=False, realign_crop_per_frame=False):
        ...
        if 'full' in preprocess.lower():
            ...
            paste_pic(path, pic_path, crop_info, new_audio_path, full_video_path, extended_crop= True if 'ext' in preprocess.lower() else False, realign_crop_per_frame=realign_crop_per_frame)

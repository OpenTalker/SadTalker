...
class SadTalker():
    ...
    def test(self, source_image, driven_audio, preprocess='crop', still_mode=False, use_enhancer=False, result_dir='./results/', expression_scale=1.0):
        ...
        #coeff2video
        batch_size = 2
        data = get_facerender_data(coeff_path, crop_pic_path, first_coeff_path, audio_path, batch_size, expression_scale=expression_scale, still_mode=still_mode, preprocess=preprocess)

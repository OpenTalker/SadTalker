...
def main(args):
    ...
    if ref_eyeblink is not None:
        ...
        ref_eyeblink_coeff_path, _, _ =  preprocess_model.generate(ref_eyeblink, ref_eyeblink_frame_dir, args.preprocess, source_image_flag=args.first_frame_only)
    else:
    ...
    if ref_pose is not None:
        if ref_pose == ref_eyeblink: 
            ...
            ref_pose_coeff_path, _, _ =  preprocess_model.generate(ref_pose, ref_pose_frame_dir, args.preprocess, source_image_flag=args.first_frame_only)
    else:
    ...
    result = animate_from_coeff.generate(data, save_dir, pic_path, crop_info, \
                                enhancer=args.enhancer, background_enhancer=args.background_enhancer, preprocess=args.preprocess, img_size=args.size, fps=fps, restore_eyes=args.restore_eyes, realign_crop_per_frame=args.realign_crop_per_frame)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--enhancer', default='gfpgan', type=str, help="Face enhancer, [gfpgan, RestoreFormer]")
    parser.add_argument('--background_enhancer', default='realesrgan', type=str,help="background enhancer, [realesrgan]")
